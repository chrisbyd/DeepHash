...
CUDA_VISIBLE_DEVICES=$gpu python train_val_script.py     --output-dim 512 --batch-size 800 --dataset $dataset --iter-num 5000  |tee > Vehicle_1600_512.txt
echo "Starting training hash bit 512"
#CUDA_VISIBLE_DEVICES=$gpu python train_val_script.py  --output-dim 512 --batch-size 800 --dataset $dataset --iter-num 10000  | tee > VehicleID_512.txt
