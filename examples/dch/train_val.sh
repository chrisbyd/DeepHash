...
CUDA_VISIBLE_DEVICES=$gpu python train_val_script.py     --output-dim 512 --batch-size 800 --dataset $dataset --iter-num 10000 --evaluate |tee > VeRi_512.txt
echo "Starting training hash bit 512"
#CUDA_VISIBLE_DEVICES=$gpu python train_val_script.py  --output-dim 512 --batch-size 800 --dataset $dataset --iter-num 10000 --evaluate | tee > VehicleID_512.txt
