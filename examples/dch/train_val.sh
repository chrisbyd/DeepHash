...
CUDA_VISIBLE_DEVICES=$gpu python train_val_script.py     --output-dim 256 --batch-size 800 --dataset $dataset --iter-num 10000 |tee > VeRi_256.txt
echo "Starting training hash bit 512"
CUDA_VISIBLE_DEVICES=$gpu python train_val_script.py  --output-dim 512 --batch-size 800 --dataset $dataset --iter-num 10000 | tee > VeRi_512.txt
