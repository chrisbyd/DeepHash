...
CUDA_VISIBLE_DEVICES=$gpu python train_val_script.py     --output-dim 256 --batch-size 300 --dataset $dataset --epochs 200
echo "Starting training hash bit 512"
CUDA_VISIBLE_DEVICES=$gpu python train_val_script.py  --output-dim 512 --batch-size 300 --dataset $dataset --epochs 200
